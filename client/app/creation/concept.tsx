...
const Concept: React.FC<{char: Partial<MasqueradeChar>, clan: Promise<JSX.Element>, arch: Promise<JSX.Element>}> = (props) => {
        ...
        <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        Investigator — detective, beat cop, governmentagent, private eye, witch-hunter 
                    </li>
                    <li>
                    ...
                    <li>
                        Soldier — bodyguard, enforcer, soldier of fortune, killer-for-hire</li>
                    <li>
                        Worker — trucker, farmer, wage earner, manservant, construction laborer
                        </li>
                </ul>
                <input type="text" id="concept" size={60}></input>
            </div>
            <div>
                <h1>Clan</h1>
                <p> Clans determine the characters look, abilities and to some extent their political affiliation.</p>
                {/* Causes hydration error and on other error */}
                {props.clan}
            </div>
            <div>
                <h1>Nature and Demeanor</h1>
                <p> Your characters Nature and Demeanor generally describes your characters behavioral traits. Their purpose is to assist in understanding a characters personality. Demeanor is the way a character presents herself to the outside world. It is the “mask” she wears to protect her inner self. A character’s Demeanor often differs from her Nature, though it might not. Demeanor does not affect gameplay rules </p>
                <p>Nature is the character’s “real” self, the person she truly is. The Archetype a player chooses reflects that character’s deep-rooted feelings about herself, others, and the world. Nature should not be the only aspect of a character’s true personality, merely the most dominant. Nature is also used to determine a character’s ability to regain Willpower points</p>
            </div>
                {props.arch}
